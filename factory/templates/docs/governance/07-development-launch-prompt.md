...
It is not a second source of truth. The development method remains [Development Traceability Method](05-development-traceability-method.md). Product and architecture truth comes from the active frozen canonical documentation baseline governed by [Source Of Truth](01-source-of-truth.md), [Documentation Baseline Lock](08-doc-baseline-lock.md), and [Product Change Control](06-product-change-control.md).
...
- docs/governance/08-doc-baseline-lock.md defines documentation baseline versioning and hash verification.
- docs/governance/05-development-traceability-method.md defines the development method.
- docs/governance/06-product-change-control.md governs post-freeze product and architecture changes.
...
2. First produce or implement the semantic issue extraction pipeline process required by docs/governance/05-development-traceability-method.md.
...
- Apply the code coverage policy from docs/governance/05-development-traceability-method.md, including required counters, thresholds, exclusions, and anti-cheating rules.
...
Sub-agent model:
Use the master/spec-steward pattern from [Development Traceability Method](05-development-traceability-method.md):
...
- One issue is one fresh agent conversation with no carryover. Progress is hook-driven (mechanical events plus injected actor/role) with a Stop-hook fallback; agents emit only semantic events. See the Autonomous Two-Agent Loop in docs/governance/05-development-traceability-method.md.
...
9. Run the method rehearsal on the throwaway example project required by [Development Traceability Method](05-development-traceability-method.md) before starting product implementation, and commit the rehearsal pass artifact at spec/development/reports/method-rehearsal-report.md.
...
If the development method changes, update [Development Traceability Method](05-development-traceability-method.md) first. Then update this prompt only to reflect that method.
