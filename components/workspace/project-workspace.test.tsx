...
describe("ProjectWorkspace — Vivi launcher gated on the agent-CLI install state", () => {
  test("both CLIs installed: the launcher bubble mounts, no install gate", async () => {
    ...
    renderWithIntl(<ProjectWorkspace />)
...
describe("ProjectWorkspace — first-boot loading state", () => {
