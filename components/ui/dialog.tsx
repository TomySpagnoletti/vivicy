      ...
      >
        ...
        {showCloseButton ? (
          <DialogPrimitive.Close
            ...
            className="absolute top-3 right-3 rounded-none opacity-70 transition-opacity hover:opacity-100 focus-visible:border-ring focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:outline-none disabled:pointer-events-none [&_svg:not([class*='size-'])]:size-4"
          >
            <X />
