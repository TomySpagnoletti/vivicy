  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        // Keep the tooltip inside the viewport: Radix flips/shifts it and never
        // lets it bleed past this padding from any edge, so a long path can't run
        // off-screen. Callers pass a wrapping/width-capped child for long content.
